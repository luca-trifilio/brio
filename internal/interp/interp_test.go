...
func TestInterpolateBasic(t *testing.T) {
	s := NewScope(NamedLayer{Name: "env", Vars: []model.Var{{Name: "host", Value: "example.com"}}})
...
func TestInterpolateOverride(t *testing.T) {
	s := NewScope(
		NamedLayer{Name: "env", Vars: []model.Var{{Name: "id", Value: "from-env"}}},
		NamedLayer{Name: "req", Vars: []model.Var{{Name: "id", Value: "from-req"}}},
	)
...
func TestInterpolateRecursive(t *testing.T) {
	s := NewScope(NamedLayer{Name: "env", Vars: []model.Var{
...
func TestRuntimeOverrides(t *testing.T) {
	s := NewScope(NamedLayer{Name: "env", Vars: []model.Var{{Name: "x", Value: "env-x"}}})
