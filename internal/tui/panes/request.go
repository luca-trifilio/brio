...
func (r *RequestModel) View(req *model.Request, scope *interp.VarScope, envName string, width, height int, focused bool) string {
...
func buildRequestLines(req *model.Request, scope *interp.VarScope, width int) []string {
	if req == nil {
